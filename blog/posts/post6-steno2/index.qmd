...
```{r}
#| label: unique ID testing further
...
Where the survival function derived from the Kaplan Meier Estimator up above could tell us how many people have survived at time $t$, the 
