  ...
  sections: 
    ...
    - name: Hobbies
      items:
        ...
        - icon: mountain
          text: Rock climbing & gardening
        - icon: dice-d20
          text: Boardgames, roleplaying games
execute: 
  echo: false
---
...
items <- c(
  "Health conomics, medical market access, quality improvement, uni- and multivariate statistical analysis. Health policy and, patient involvement.",
